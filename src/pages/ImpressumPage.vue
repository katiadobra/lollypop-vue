...
<template>
  <section class="terms">
    ...
    <div class="terms-block">
      <p>Our studio is located in Wünsdorf, 15806.</p>
      <p>Please note we’re not a café and do not have a seating area.</p>
      <p>If you have a question, please email us.</p>
      <p>Visits &amp; pick-ups by appointment only.</p>
    </div>
    ...
    <div class="terms-block">
      ...
      <ul>
        ...
        <li>Inhaltsdaten (z.B. Texteingaben in Kontaktformularen)</li>
