    ...
    <n-drawer v-model:show="mobileMenuOpen" placement="left" width="80vw">
      <n-drawer-content title="Menu" closable @close="mobileMenuOpen = false">
        <div class="mobile-nav">
          ...
          <RouterLink to="/favorites" class="mobile-nav-link" @click="mobileMenuOpen = false">
            Favorites
            <span v-if="favoriteCount" class="mobile-favorite-badge">{{ favoriteCount }}</span>
          </RouterLink>
...
@media (max-width: 780px) {
  ...
  .header-actions .link-button .cart-badge,
  .header-actions .link-button .favorite-badge {
    position: absolute;
    top: -6px;
    right: -8px;
    margin: 0;
